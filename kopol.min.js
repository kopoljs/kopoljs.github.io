...
function readData(a,i){var e=[],n=[];$.ajaxPrefilter(function(a){if(a.crossDomain&&jQuery.support.cors){var i="http:"===window.location.protocol?"http:":"https:";a.url=i+"//cors-anywhere.herokuapp.com/"+a.url}}),$.get("https://bahadorsaket.com/others/ranking2.txt",function(r){allText=r;for(var t=allText.split(/\r\n|\n/),l=t[0].split(","),o=1;o<t.length;o++){var c=t[o].split(",");c.length==l.length&&""!=c[0]&&(e.push([c[0],c[1],c[2],c[3]]),n.push([c[4],c[5],c[6]]))}var u=calculateEffectiveness(n,a[3],a[4],a[5]);i(u,e)})}function getChartPeformance(a,i){readData(a,function(e,n){var r=new ml.DecisionTree({data:n,result:e});r.build();var t=getRecommendations(a,n,e,r);i(t)})}function checkTaskValidity(a){return"Retrieve"==a||"Anomalies"==a||"Cluster"==a||"Correlation"==a||"Derived"==a||"Distribution"==a||"Extremum"==a||"Filter"==a||"Order"==a||"Range"==a}function calculateEffectiveness(a,e,n,r){var t=[];for(i=0;i<a.length;i++){var l=(e*(1-Number(a[i][2])/215)+n*(Number(a[i][0])/100)+r*(1-Number(a[i][1])/5))/(e+n+r);t.push(l)}return t}function getRecommendations(a,i,e,n,r){var t=["PieChart","BarChart","LineChart","Scatterplot","Table"];for(VisRanking={},j=0;j<t.length;j++){"Numerical"==a[1]||"Numerical"==a[2]?"Numerical"!=a[2]&&(a[1]=a[2],a[2]="Numerical"):("Ordinal"==a[1]&&"Nominal"==a[2]&&(a[1]="Nominal",a[2]="Numerical"),"Ordinal"==a[1]&&"Ordinal"==a[2]&&(a[1]="Ordinal",a[2]="Numerical"),"Nominal"==a[1]&&"Nominal"==a[2]&&(a[1]="Nominal",a[2]="Numerical"),"Nominal"==a[1]&&"Ordinal"==a[2]&&(a[1]="Nominal",a[2]="Numerical"));var l=calculateRanking(a,t[j],i,e);name=t[j],VisRanking[name]=l}return checkTaskValidity(a[0])?Object.keys(VisRanking).sort(function(a,i){return VisRanking[i]-VisRanking[a]}):["Invalid task type! Please pick a task first."]}function calculateRanking(a,e,n){var r=0,t=0;for(i=0;i<n.length;i++)a[0]==n[i][0]&&a[1]==n[i][1]&&a[2]==n[i][2]&&e==n[i][3]&&(r+=n[i][4],t++);return r/=t}
