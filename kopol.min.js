...
function readData(a){var e=[],i=[],n=new XMLHttpRequest;n.addEventListener("load",function(){allText=this.responseText;for(var n=allText.split(/\r\n|\n/),r=n[0].split(","),t=1;t<n.length;t++){var l=n[t].split(",");l.length==r.length&&(e.push([l[0],l[1],l[2],l[3]]),i.push(l[4]))}a(i,e)}),n.open("GET","http://bahadorsaket.com/others/ranking.csv"),n.send()}function getChartPeformance(a,e){readData(function(i,n){var r=new ml.DecisionTree({data:n,result:i});r.build();var t=getRecommendations(a,n,i,r);e(t)})}function checkTaskValidity(a){return"Retrieve"==a||"Anomalies"==a||"Cluster"==a||"Correlations"==a||"Derived"==a||"Distribution"==a||"Extremum"==a||"Filter"==a||"Order"==a||"Range"==a}function getRecommendations(a,e,i,n,r){var t=["PieChart","BarChart","LineChart","Scatterplot","Table"];for(VisRanking={},j=0;j<t.length;j++){"Numerical"!=a[1]&&"Nominal"!=a[1]&&"Ordinal"!=a[1]&&console.log("Parameter 2 is incorrect! Accepted data attributes [Ordinal,Nominal,Numerical]"),"Numerical"!=a[2]&&"Nominal"!=a[2]&&"Ordinal"!=a[2]&&console.log("Parameter 3 is incorrect! Accepted data attributes [Ordinal,Nominal,Numerical]"),"Numerical"==a[1]||"Numerical"==a[2]?"Numerical"!=a[2]&&(a[1]=a[2],a[2]="Numerical"):("Ordinal"==a[1]&&"Nominal"==a[2]&&(a[1]="Nominal",a[2]="Numerical"),"Ordinal"==a[1]&&"Ordinal"==a[2]&&(a[1]="Ordinal",a[2]="Numerical"),"Nominal"==a[1]&&"Nominal"==a[2]&&(a[1]="Nominal",a[2]="Numerical"),"Nominal"==a[1]&&"Ordinal"==a[2]&&(a[1]="Nominal",a[2]="Numerical"));var l=calculateRanking(n.classify([a[0],a[1],a[2],t[j]]));name=t[j],VisRanking[name]=l}return checkTaskValidity(a[0])?Object.keys(VisRanking).sort(function(a,e){return VisRanking[e]-VisRanking[a]}):["Invalid task type! Please pick a task first."]}function calculateRanking(a){var e=0;for(key in a)"Very Good"==key&&(e+=3*a["Very Good"]),"Good"==key&&(e+=2*a.Good),"OK"==key&&(e+=1*a.OK),"Bad"==key&&(e+=-2*a.Bad),"Very Bad"==key&&(e+=-3*a["Very Bad"]);return e}